...
plot.export('docs/_static/curve_plotting', ratio='silver')
...
# export it to a websvg (which doesnt convert text to paths)
plot.export('docs/_static/int_norm', ratio='silver')
...
plot.export('docs/_static/identity', ratio='silver')
...
plot.ylim(0, 12000)
plot.legend(loc=2)
plot.export('docs/_static/trail_elevations')
